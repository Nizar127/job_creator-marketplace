...
const ITEMS = [
  {title: dates[0], data: [{hour: '12am', duration: '1h', title: 'Work at Global Venture Industries'}]},
  {title: dates[1], data: [{hour: '4pm', duration: '1h', title: 'Catering at CIMB Bank Event'}, {hour: '8am', duration: '3h', title: 'Catering'}]},
  {title: dates[2], data: [{hour: '1pm', duration: '1h', title: 'Bartender at Panorama Signature'}, {hour: '6pm', duration: '5h', title: 'Bartender'}, {hour: '12pm', duration: '1h', title: 'Practice'}]},
  {title: dates[3], data: [{hour: '12am', duration: '1h', title: 'Food'}]},
  {title: dates[4], data: [{}]},
